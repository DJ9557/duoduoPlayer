...
@interface DJP_SMBListFileViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic,strong) UITableView *myTableView;
@property (nonatomic, strong) NSMutableArray *dataArray;

@end

@implementation DJP_SMBListFileViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DJSMBFileTootListTableViewCell * cell=[tableView dequeueReusableCellWithIdentifier:@"DJDJSMBFileTootListTableViewCell" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    SMBFile *file = [self.dataArray objectAtIndex:indexPath.row];
    if (file.isDirectory) {
        DJP_SMBListFileViewController *listFile = [[DJP_SMBListFileViewController alloc] init];
        listFile.file = file;
